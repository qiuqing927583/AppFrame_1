...
/**
 * class description: VoiceAssistantFragment
 * author: Yusz
 * Date: 2018-8-7
 */

public class VoiceAssistantFragment extends Fragment implements IStatus{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_voiceassistant, container, false);
        View newView = null;
        try {
    ...
    private View InitView(View view){
        mVoiceWaveView = (SDKAnimationView) view.findViewWithTag("voicewave_view");
        ...
        adapter = new VoiceSayAdapter(getActivity(),voiceData);
    ...
    private void InitVoice()throws Exception{
        ...
        myRecognizer = new MyRecognizer(getActivity(), recogListener);

        IWakeupListener listener = new RecogWakeupListener(handler);
        myWakeup = new MyWakeup(getActivity().getApplicationContext(), listener);
    }
    private void start() {
...
//                            Intent intent = new Intent(getActivity(), WriteEmailActivity.class);
