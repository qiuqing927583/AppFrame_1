...
import com.android.yawei.jhoa.facescan.widget.BrightnessTools;
import com.android.yawei.jhoa.facescan.widget.FaceRoundView;
import com.android.yawei.jhoa.facescan.widget.WaveHelper;
import com.android.yawei.jhoa.facescan.widget.WaveView;
...
import static com.android.yawei.jhoa.facescan.faceuntil.Base64RequestBody.readFile;
    ...
    private void initView() {
        ...
        faceDetectManager.setOnFaceDetectListener(new FaceDetectManager.OnFaceDetectListener() {
            ...
            public void onDetectFace(final int retCode, FaceInfo[] infos, ImageFrame frame) {
                ...
                if (retCode == 0) {//当retCode为0的时候，表示检测到人脸
        ...
        faceDetectManager.setOnTrackListener(new FaceFilter.OnTrackListener() {
            ...
            public void onTrack(FaceFilter.TrackedModel trackedModel) {
                if (trackedModel.meetCriteria() && mGoodDetect) {
                    //upload(trackedModel);
                    mGoodDetect = false;
                    if (!mSavedBmp && mBeginDetect) {//该方法中有saveFaceBmp可保存人脸图片到手机中
