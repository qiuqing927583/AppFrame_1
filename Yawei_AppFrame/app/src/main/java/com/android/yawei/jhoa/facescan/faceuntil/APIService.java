...
import com.android.yawei.jhoa.facescan.model.RegParams;
import com.android.yawei.jhoa.facescan.parser.RegResultParser;
...
public class APIService {
    ...
    private String urlAppendCommonParams(String url) {
        ...
        sb.append("?access_token=").append(Constants.ACCESS_TOKEN);
        return sb.toString();
    }
